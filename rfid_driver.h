...
#define RFID_H_
	...
	void PCD_WriteRegisters(PCD_Register reg, uint8_t count, uint8_t *values);
	uint8_t PCD_ReadRegister(PCD_Register reg);
	void PCD_ReadRegisters(PCD_Register reg, uint8_t count, uint8_t *values, uint8_t rxAlign);
	...
	/////////////////////////////////////////////////////////////////////////////////////
	StatusCode PCD_TransceiveData(uint8_t *sendData, uint8_t sendLen, uint8_t *backData, uint8_t *backLen, uint8_t *validBits, uint8_t rxAlign, int checkCRC);
	StatusCode PCD_CommunicateWithPICC(uint8_t command, uint8_t waitIRq, uint8_t *sendData, uint8_t sendLen, uint8_t *backData, uint8_t *backLen, uint8_t *validBits, uint8_t, int checkCRC);
	...
	// Support functions
	/////////////////////////////////////////////////////////////////////////////////////
	StatusCode PCD_MIFARE_Transceive(uint8_t *sendData, uint8_t sendLen, int acceptTimeout);
